...
## XCSS Initial Prompt for Frontend Style Context Exploration
...
- Type `exit` to quit the session when done.  
- Type `help` to see the full list of available commands for querying style context.  
- Use `$ {command}` to execute commands from the command set and retrieve detailed information about your design tokens, dependencies, and style inheritance.
