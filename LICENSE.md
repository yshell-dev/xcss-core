...
- **"Alchira"**: The software tool, including its binary, documentation, and associated materials.
- **"We" | "Us"**: Vyshnav Prasad, git@github.com:yshelldev, the licensor.
- **"You"**: The individual or entity using Alchira.
...
Alchira and all intellectual property rights worldwide related to it remain exclusively owned by Us. No ownership or rights are transferred except as expressly granted in this Agreement.

### 4. Restrictions

You may not, without explicit prior written consent from Us:
...
You agree to keep confidential all non-public information of Alchira Compiler, including source code, algorithms, methodologies, and implementation details.
